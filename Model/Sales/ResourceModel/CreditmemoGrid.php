 ...
 */
class CreditmemoGrid extends Grid
{
    /**
     * @return Select
     */
    protected function getGridOriginSelect()
    {
        ...
        $select->joinLeft(
            ['sales_invoice' => $this->getTable('sales_invoice')],
            'sales_creditmemo.invoice_id = sales_invoice.entity_id',
            []
        );
        $select->joinLeft(
            ...
            . 'sales_creditmemo.order_id = sales_order_payment.parent_id)',
            []
        );
        return $select;
    }
